...
const { sequelize } = require('../server/database/connection'); // Update the path accordingly
const Reviews = require('../server/models/Reviews.js'); // Update the path accordingly
